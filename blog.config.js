...
const BLOG = {
  ...
  REDIRECT_ENABLE: process.env.NEXT_PUBLIC_REDIRECT_ENABLE || false, // 是否将不存在的地址重定向到新域名；也可在 Notion_Config 中配置
  REDIRECT_LINK: process.env.NEXT_PUBLIC_REDIRECT_LINK || '', // 不存在地址的重定向目标域名
