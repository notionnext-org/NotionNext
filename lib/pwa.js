...
export const getPwaConfig = ({ siteInfo, notionConfig } = {}) => {
  ...
  // Only explicit PWA_ICON_192/512 can override them.
  ...
  const icon192 = notionConfig.PWA_ICON_192 || DEFAULT_ICON_192
  const icon512 = notionConfig.PWA_ICON_512 || DEFAULT_ICON_512
  const icon192Maskable = notionConfig.PWA_ICON_192_MASKABLE || DEFAULT_ICON_192_MASKABLE
  const icon512Maskable = notionConfig.PWA_ICON_512_MASKABLE || DEFAULT_ICON_512_MASKABLE
